            ...
            <div className="grid xl:grid-cols-2 gap-10">
              <div className="flex flex-col justify-end items-start cardbg white rounded-[20px] w-[100%] h-[680px] p-10">
                ...
                <p className="font-16 font-inter font-normal leading-5 mt-3 mb-8 opacity-60">
                  The terms monitoring and observability are prevalent in the field. The terms monitoring and observability.
                </p>
                ...
                <div className="">
                  {BlogCard && BlogCard.length > 0 ? (
                    BlogCard.map((item, index) => (
                      <Tilt key={`tilt-${index}`}>
                        <div className="sm:flex bg-white gap-4 p-5 rounded-[20px] mb-10">
