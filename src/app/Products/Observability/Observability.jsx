          ...
          <div>
            <div className="grid md:grid-cols-2 items-center gap-36 mt-20">
              ...
              <Image src="/lambu.png" width={32} height={56} alt="lambu" className="mb-10" />
                ...
                <p className="font-24 font-normal font-inter leading-8 mt-8 mb-10 opacity-60">
                  Detects and mitigate biases and drifts in real-time, ensuring
                  fairness and reliability throughout the model lifecycle.
                </p>
              </div>
            </div>
            <div className="grid md:grid-cols-2 items-center gap-36 mt-20">
            ...
            <div className="grid md:grid-cols-2 items-center gap-36 mt-20">
              ...
              <Image src="/lambu.png" width={32} height={56} alt="lambu" className="mb-10" />
                ...
                <p className="font-24 font-normal font-inter leading-8 mt-8 mb-10 opacity-60">
                  ...
                  interpret model decisions and communicate complex concepts in
            ...
            <div className="grid md:grid-cols-2 items-center gap-36 mt-20">
              ...
              <Image src="/lambu.png" width={32} height={56} alt="lambu" className="mb-10" />
                ...
                <p className="font-24 font-normal font-inter leading-8 mt-8 mb-10 opacity-60">
                  Dive deep into model behavior with interactive profiling tools
                  that enable detailed analysis of performance metrics, feature
                  importance, and prediction accuracy.
                </p>
              </div>
            </div>
          </div>
