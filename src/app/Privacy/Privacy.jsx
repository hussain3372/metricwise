          ...
          <div>
            ...
            <div>
              <ul className="list-disc pl-8 space-y-2 pb-6">
                <li className="font-20 font-normal font-inter leading-6 mt-5">Domain name</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Browser type and operating system</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Web pages visited and links clicked</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">IP address</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Time spent on the Site</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Referring URL</li>
              </ul>
            </div>
          </div>
          <div>
            ...
            <div>
              <ul className="list-disc pl-8 space-y-2 pb-6">
                <li className="font-20 font-normal font-inter leading-6 mt-5">Providing and improving our Site</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Communicating with you about your use of the Site and responding to your inquiries</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Customizing content and experiences on the Site</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Sending you email marketing and newsletters</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Assisting with advertising and evaluating its success</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Understanding how users interact with our Site</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Research and analytics</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Administering surveys</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Complying with legal obligations</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Investigating and preventing illegal activities or violations of our Terms of Service or Policy</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">We may also inform you about other purposes from time to time.</li>
              </ul>
            </div>
          </div>
          <div>
            ...
            <div>
              <ul className="list-disc pl-8 space-y-2 pb-6">
                <li className="font-20 font-normal font-inter leading-6 mt-5">Business Transfers: If MetricWise is involved in a business transfer, your information may be transferred as part of that process.</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Legal Process: We may disclose your information in response to a legal request or to protect our rights or safety.</li>
                <li className="font-20 font-normal font-inter leading-6 mt-5 mb-6">Aggregate Information: We share anonymized information about users for marketing, advertising, research, and similar purposes.</li>
              </ul>
            </div>
          </div>
          <div>
