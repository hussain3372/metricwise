...
export const commerce = [
  {
    icon: "/e1.svg",
    title: "Demand Forcasting and Inventory Optimization",
    Items: [
      ...
      "Increase sales and profitability by analyzing customer purchasing behavios and trends to identify opportunities for cross-selling and upselling.",
    ],
  },
  {
    icon: "/e2.svg",
    title: "Personalized Marketing and Customer Experienced",
    Items: [
      ...
      "Improve conversion rates and customer satisfaction by leveraging AI-driven recommendation engines to suggest relevant products and offers to customers in real-time.",
    ],
  },
  {
    icon: "/e3.svg",
    title: "Loss Prevention and Security",
    Items: [
      ...
      "Enhance security and compliance with regulatory requirements by analyzing transaction data and identifying potential instances of fraud or financial misconduct using AI/ML algorithms.",
    ],
  },
];
export const health = [
  {
    icon: "/h1.svg",
    title: "Medical Diagnosis & Planning",
    Items: [
      ...
      "Improve patient outcomes and reduce diagnostic errors by providing clinicians with decision support tools that integrate evidence-based guidelines and best practices.",
    ],
  },
  {
    icon: "/h2.svg",
    title: "Patient Monitoring & Remote Care",
    Items: [
      ...
      "Improve patient access to care and reduce healthcare costs by enabling virtual consultations and telemedicine services using AI-powered chatbots and virtual assistants.",
    ],
  },
  {
    icon: "/h3.svg",
    ...
    Items: [
      ...
      "Identify potential drug candidates and therapeutic targets more efficiently by mining large-scale biomedical data sets and uncovering hidden patterns and relationships.",
    ],
  },
];
export const social = [
  ...
  },
  {
    ...
    Items: [
      ...
      "Continuous monitoring ensures that recommendation algorithms remain transparent, unbiased, and compliant with content policies and regulations.",
    ],
  },
  {
    icon: "/s3.svg",
    ...
    Items: [
      ...
      "Optimize ad targeting strategies by utilizing AI/ML algorithms to analyze user demographics and behavior, improving ad relevance and conversion rates.",
    ],
  },
];
export const estate = [
  {
    ...
    Items: [
      ...
      "Implement continuous monitoring to ensure model accuracy and reliability, adapting valuation methodologies based on evolving market conditions.",
    ],
  },
  {
    icon: "/es2.svg",
    ...
    Items: [
      "Enhance tenant screening processes by leveraging AI/ML algorithms to analyze applicant data and predict tenant reliability.",
      "Regular monitoring ensures that screening algorithms remain transparent, unbiased, and compliant with fair housing regulations.",
    ],
  },
  {
    icon: "/es3.svg",
    ...
    Items: [
      "Optimize real estate investment portfolios by utilizing AI/ML algorithms to analyze market data and identify investment opportunities.a",
      "Continuous monitoring ensures that investment strategies align with risk tolerance and financial objectives, maximizing portfolio performance while minimizing risks.",
    ],
  },
];
export const education = [
  ...
  },
  {
    ...
    Items: [
      ...
      "Continuous monitoring ensures that AI-supported teaching practices align with pedagogical principles and promote positive learning outcomes for all students.",
    ],
  },
];
export const vehicle = [
  {
    ...
    Items: [
      "Utilize AI/ML algorithms to power advanced driver assistance systems (ADAS) and autonomous driving features, improving vehicle safety and reducing accidents.",
      "Implement continuous monitoring to ensure that safety systems operate reliably under various driving conditions and scenarios.",
    ],
  },
  {
    icon: "/ve2.svg",
    title: "Ethical Decisions Making",
    Items: [
      "Enhance autonomous vehicle algorithms with ethical decision-making frameworks to prioritize passenger and pedestrian safety in challenging situations.",
      "Regular monitoring ensures that ethical decision-making algorithms adhere to legal and ethical standards, promoting public trust and acceptance of autonomous vehicles.",
    ],
  },
  {
    icon: "/ve3.svg",
    ...
    Items: [
      ...
      "Continuous monitoring ensures compliance with data protection regulations and industry best practices, minimizing the risk of data breaches and unauthorized access.",
    ],
  },
];
