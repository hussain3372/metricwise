        ...
        <div className="bg-[url('/hero-gradient.png')] bg-no-repeat bg-cover bg-center pt-20 pb-32 sm:pb-64 m-auto px-4 sm:px-0">
          <div className="flex flex-col justify-start items-center text-center">
            ...
            <div className="flex justify-center items-center gap-4 mt-4">
              <button className="bg-[#042440] border-none rounded-lg px-4 py-3 font-12 font-medium text-white">Get Started Now</button>
              <button className="bg-none border border-[#042440] rounded-lg px-4 py-3 font-12 font-medium text-[#042440]">Book a demo</button>
            </div>
          </div>
        </div>
